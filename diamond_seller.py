...
def main():
    ...
    ch = Channel[Recv[str, Send[dict[DiamondColour, int], Offer[Recv[str, Send[str, End]], Recv[DiamondColour, Send[str, End]]]]]]()
    req = ch.recv()
    catalogue = {
    ...
    match ch.offer():
        ...
        case Branch.RIGHT:
            colour = ch.recv()
            ch.send(f'Thanks for purchasing a {colour} diamond, you spent ${catalogue[colour]}')
